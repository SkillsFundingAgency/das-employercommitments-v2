...
namespace SFA.DAS.EmployerCommitmentsV2.Web.UnitTests.Extensions
{
    ...
    public class GetCohortCardLinkViewModelExtentsionsTests
    {
        ...
        public class GetCohortCardLinkViewModelTestsFixture
        {
            ...
            public void VerifyCohortsInDraftIsCorrect(CohortsSummaryViewModel result)
            {
            ...
            public void VerifyCohortsInReviewIsCorrect(CohortsSummaryViewModel result)
            {
            ...
            public void VerifyCohortsWithProviderIsCorrect(CohortsSummaryViewModel result)
            {
            ...
            public void VerifyCohortsWithTransferSenderIsCorrect(CohortsSummaryViewModel result)
            {
            ...
            public void VerifySelectedCohortStatusIsCorrect(CohortsSummaryViewModel result, CohortStatus expectedCohortStatus)
            {
            ...
            public void VerifyNoDrillDownLinks(CohortsSummaryViewModel result)
            {
            ...
            public CohortsSummaryViewModel GetCohortCardLinkViewModel(CohortStatus selectedCohortStatus = CohortStatus.Draft)
            {
