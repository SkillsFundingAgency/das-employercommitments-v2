...
{
    public class CohortsSummaryViewModelMapper : IMapper<CohortsRequest, CohortsSummaryViewModel>
    {
        ...
        public async Task<CohortsSummaryViewModel> Map(CohortsRequest source)
        {
