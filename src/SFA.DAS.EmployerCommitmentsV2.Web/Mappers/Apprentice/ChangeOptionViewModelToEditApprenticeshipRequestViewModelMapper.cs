...
public class ChangeOptionViewModelToEditApprenticeshipRequestViewModelMapper : IMapper<ChangeOptionViewModel, EditApprenticeshipRequestViewModel>
{
    ...
    public ChangeOptionViewModelToEditApprenticeshipRequestViewModelMapper(ICommitmentsApiClient commitmentsApiClient, ICacheStorageService cacheStorageService)
    {
    ...
    {
        var editViewModel = await _cacheStorageService.RetrieveFromCache<EditApprenticeshipRequestViewModel>((Guid)source.CacheKey);
