    ...
    public class ApprenticeshipDetailsRequestToViewModelMapper : IMapper<ApprenticeshipDetailsRequest, ApprenticeshipDetailsRequestViewModel>
    {
        ...
        public async Task<ApprenticeshipDetailsRequestViewModel> Map(ApprenticeshipDetailsRequest source)
        {
            try
            {
                ...
                var overlappingTrainingDateRequest = overlappingTrainingDateRequestTask.Result;
                ...
                var hasPendingoverlappingTrainingDateRequest = overlappingTrainingDateRequest != null && overlappingTrainingDateRequest?.Status == OverlappingTrainingDateRequestStatus.Pending;
                ...
                var result = new ApprenticeshipDetailsRequestViewModel
                {
                    ...
                    DeliveryModel = apprenticeship.DeliveryModel.ToIrregularDescription(),
