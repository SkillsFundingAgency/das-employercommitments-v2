...
namespace SFA.DAS.EmployerCommitmentsV2.Web.Extensions
{
    public static class ITempDataDictionaryExtensions
    {
        ...
        public static readonly string FlashMessageTempDetailKey = "DetailMessage";
        ...
        public static void AddFlashMessage(this ITempDataDictionary tempData, string message, string details, FlashMessageLevel level)
        {
            tempData.AddFlashMessage(message, level);
